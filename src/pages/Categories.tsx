...
const categories = [
  ...
  { name: "Electrical", icon: Zap, gradient: "from-amber-400 to-orange-500" },
  { name: "Cleaning", icon: Sparkles, gradient: "from-emerald-400 to-teal-500" },
  { name: "Delivery", icon: Truck, gradient: "from-violet-400 to-purple-500" },
  { name: "Repairs", icon: Settings, gradient: "from-rose-400 to-pink-500" },
  { name: "Gadgets", icon: Smartphone, gradient: "from-cyan-400 to-blue-500" },
  { name: "Fashion", icon: Shirt, gradient: "from-fuchsia-400 to-pink-500" },
  { name: "Food & Beverages", icon: UtensilsCrossed, gradient: "from-orange-400 to-red-500" },
  { name: "Beauty & Wellness", icon: Heart, gradient: "from-pink-400 to-rose-500" },
  { name: "Other", icon: MoreHorizontal, gradient: "from-slate-400 to-gray-500" },
];
  ...
  return (
    <div className="px-5 pt-4">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        <p className="text-muted-foreground text-sm mt-1">Find services or products by category</p>
      </motion.div>
